...
public class aplikasiPengelolaKontak extends javax.swing.JFrame {
  ...
  public aplikasiPengelolaKontak() {
    initializeDatabase();  // Setup database (membuat tabel jika belum ada)
    initComponents();      // Inisialisasi komponen GUI
    initializeTableModel(); // Setup DefaultTableModel ke JTable
    refreshContacts();     // Load data awal dari database dan tampilkan ke tabel
}
    ...
    private void initComponents() {
        ...
        jScrollPane1.setMinimumSize(new java.awt.Dimension(425, 200));
        ...
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_END;
        gridBagConstraints.insets = new java.awt.Insets(10, 0, 10, 9);
    ...
    private void cbCategoryItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbCategoryItemStateChanged
        ...
        String selectedCategory = (String) evt.getItem();
    ...
    if (name.isEmpty() || phone.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Nama dan Telepon tidak boleh kosong.", "Peringatan", JOptionPane.WARNING_MESSAGE);
        return;
    }
    ...
    insertContact(name, phone, category);
    }//GEN-LAST:event_btnAddActionPerformed

    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
    int selectedRow = tblContacts.getSelectedRow();
    if (selectedRow == -1) {
        JOptionPane.showMessageDialog(this, "Pilih kontak yang akan diedit.", "Peringatan", JOptionPane.WARNING_MESSAGE);
        return;
    }
    ...
    int selectedRow = tblContacts.getSelectedRow();
    if (selectedRow == -1) {
        JOptionPane.showMessageDialog(this, "Pilih kontak yang akan dihapus.", "Peringatan", JOptionPane.WARNING_MESSAGE);
        return;
    }
    ...
    populateFieldsFromSelectedRow(); // Panggil fungsi saat baris diklik        // TODO add your handling code here:
...
private void initializeDatabase() {
    try {
        ...
        JOptionPane.showMessageDialog(this, "Gagal menginisialisasi database.", "Error", JOptionPane.ERROR_MESSAGE);
        ex.printStackTrace();
    }
}

// Fungsi untuk menangani pengisian data dari baris yang dipilih di JTable ke input form
private void populateFieldsFromSelectedRow() {
    int selectedRow = tblContacts.getSelectedRow();
    if (selectedRow != -1) { // Pastikan ada baris yang dipilih
        // Ambil data dari baris yang dipilih menggunakan DefaultTableModel
        ...
        JOptionPane.showMessageDialog(this, "Pilih baris terlebih dahulu!", "Informasi", JOptionPane.INFORMATION_MESSAGE);
    }
}
...
private void refreshContacts() {
    ...
    try (Statement stmt = conn.createStatement();
        ...
        JOptionPane.showMessageDialog(this, "Gagal memuat kontak.", "Error", JOptionPane.ERROR_MESSAGE);
        ex.printStackTrace();
    }
}

// Menambahkan Kontak Baru
private void insertContact(String name, String phone, String category) {
    try {
...
private void updateContact() {
    ...
    try {
        ...
        String query = "UPDATE contacts SET name = ?, phone = ?, category = ? WHERE id = ?";
        PreparedStatement stmt = conn.prepareStatement(query);
        stmt.setString(1, name);
        stmt.setString(2, phone);
        stmt.setString(3, category);
        ...
        JOptionPane.showMessageDialog(this, "Gagal mengupdate kontak.", "Error", JOptionPane.ERROR_MESSAGE);
        ex.printStackTrace();
    }
}
...
private void saveToCSV() {
    try (PrintWriter writer = new PrintWriter(new File("contacts.csv"))) {
        ...
        JOptionPane.showMessageDialog(this, "Kontak berhasil diexport ke CSV.");
    } catch (Exception ex) {
...
private void loadFromCSV() {
    try (BufferedReader br = new BufferedReader(new FileReader("contacts.csv"))) {
        ...
        while ((line = br.readLine()) != null) {
            ...
            insertContact(data[1], data[2], data[3]);
        }
        refreshContacts();
        JOptionPane.showMessageDialog(this, "Kontak berhasil diimpor dari CSV.");
    } catch (Exception ex) {
...
// Fungsi Validasi untuk Input Nomor Telepon
